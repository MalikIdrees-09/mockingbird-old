...
const SearchPage = () => {
  ...
  const performSearch = useCallback(async (searchQuery, type) => {
    ...
    try {
      ...
      if (type === "users") {
        endpoint = `https://backend-server-453975176199.us-central1.run.app/users/search?${params}`;
      } else if (type === "posts") {
        params.append("type", "all");
        endpoint = `https://backend-server-453975176199.us-central1.run.app/posts/search?${params}`;
      }
