...
const Settings = () => {
  ...
  const handleProfileUpdate = async (e) => {
    ...
    try {
      ...
      const response = await fetch(
        `https://mockingbird-backend.idrees.in/users/${user._id}`,
        {
          method: "PATCH",
          headers: {
  ...
  const handlePasswordChange = async (e) => {
    ...
    try {
      ...
      const response = await fetch("https://mockingbird-backend.idrees.in/auth/change-password", {
        method: "POST",
        headers: {
          "Content-Type": "application/json",
          Authorization: `Bearer ${token}`,
  ...
  const handleEmailChange = async (e) => {
    ...
    try {
      ...
      const response = await fetch("https://mockingbird-backend.idrees.in/auth/change-email", {
        method: "POST",
        headers: {
          "Content-Type": "application/json",
          Authorization: `Bearer ${token}`,
              ...
              >
                <CardContent sx={{ p: { xs: 2, md: 4 } }}>
                  <Box sx={{ display: "flex", alignItems: "center", mb: 3 }}>
                    <Avatar
                      src={
                        user.picturePath ? `https://mockingbird-backend.idrees.in/assets/${user.picturePath}?v=${profilePictureKey}` : undefined
                      }
                      sx={{
                        width: 80,
                        height: 80,
                    ...
                    >
                      ...
                      <CardContent sx={{ textAlign: "center", pb: 3 }}>
                        <Box sx={{ position: "relative", display: "inline-block", mb: 2 }}>
                          <Avatar
                            src={user.picturePath ? `https://mockingbird-backend.idrees.in/assets/${user.picturePath}?v=${profilePictureKey}` : undefined}
                            sx={{
                              width: 150,
                              height: 150,
