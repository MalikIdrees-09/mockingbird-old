...
const UserManagement = ({ userId }) => {
  ...
  const getUsers = useCallback(async () => {
    ...
    try {
      ...
      const response = await fetch(
        `https://mockingbird-backend.idrees.inadmin/users?page=${page}&search=${searchTerm}`,
        {
          method: "GET",
          headers: {
  ...
  const handleBanUser = async (user) => {
    try {
      const response = await fetch(`https://mockingbird-backend.idrees.inadmin/users/${user._id}/ban`, {
        method: "PATCH",
        headers: {
          Authorization: `Bearer ${token}`,
          "Content-Type": "application/json",
  ...
  const handleDeleteUser = async (user) => {
    try {
      const response = await fetch(`https://mockingbird-backend.idrees.inadmin/users/${user._id}`, {
        method: "DELETE",
        headers: {
          Authorization: `Bearer ${token}`,
          "Content-Type": "application/json",
