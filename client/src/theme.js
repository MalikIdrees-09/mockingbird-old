    ...
    palette: {
      ...
      ...(mode === "dark"
        ? {
            ...
            neutral: {
              dark: "rgba(248, 250, 255, 0.92)",
              main: "rgba(220, 225, 235, 0.78)",
              mediumMain: "rgba(200, 208, 224, 0.66)",
              medium: "rgba(178, 187, 206, 0.54)",
              light: "rgba(129, 138, 163, 0.4)",
            },
            background: {
              default: "#0f1118",
              alt: "rgba(18, 20, 30, 0.92)",
              paper: "rgba(22, 26, 38, 0.92)",
              subtle: "rgba(28, 32, 44, 0.88)",
            },
            text: {
              primary: "rgba(248, 250, 255, 0.92)",
              secondary: "rgba(206, 213, 224, 0.72)",
              muted: "rgba(206, 213, 224, 0.54)",
            },
            divider: "rgba(235, 235, 245, 0.12)",
            action: {
              hoverOpacity: 0.12,
        ...
        : {
            ...
            background: {
              default: "#f9f7f2",
              alt: "rgba(255, 255, 255, 0.94)",
              paper: "#ffffff",
              subtle: "rgba(240, 236, 228, 0.55)",
            },
            text: {
              primary: colorTokens.newsprint[900],
              secondary: colorTokens.newsprint[700],
            },
            divider: "rgba(28, 34, 47, 0.12)",
            action: {
              hoverOpacity: 0.1,
              selectedOpacity: 0.14,
              focusOpacity: 0.16,
              disabledOpacity: 0.38,
              disabledBackground: "rgba(28, 34, 47, 0.08)",
            },
          }),
    },
    typography: {
