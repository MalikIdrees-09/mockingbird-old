...
3. **Check Status**: Visit `https://mockingbird-backend.idrees.inapi/rss/status`
4. **Test Feed**: Visit `https://mockingbird-backend.idrees.inapi/rss/test`
5. **Manual Sync**: `POST https://mockingbird-backend.idrees.inapi/rss/sync`
