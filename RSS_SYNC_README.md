...
3. **Check Status**: Visit `https://mockingbird-backend.idrees.in/api/rss/status`
4. **Test Feed**: Visit `https://mockingbird-backend.idrees.in/api/rss/test`
5. **Manual Sync**: `POST https://mockingbird-backend.idrees.in/api/rss/sync`
