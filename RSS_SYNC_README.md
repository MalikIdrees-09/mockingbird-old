...
3. **Check Status**: Visit `http://localhost:5000/api/rss/status`
4. **Test Feed**: Visit `http://localhost:5000/api/rss/test`
5. **Manual Sync**: `POST http://localhost:5000/api/rss/sync`
